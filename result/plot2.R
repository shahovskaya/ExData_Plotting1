...
plot(total$DateTime, as.numeric(as.character(total$Global_active_power)),type="l",ylab="Global Active Power (Kilowatts)", xlab="")
ggsave("plot2.png", width=127, height=127, units="mm")